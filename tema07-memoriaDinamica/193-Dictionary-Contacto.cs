...
/*
193. Haz una variante más del ejercicio anterior: Crea un diccionario simple de
inglés a español: el programa deberá contener al menos 10 palabras prefijadas. 
Mostrará un menú que permita añadir una nueva palabra (junto con su traducción),
buscar la traducción de una palabra, ver la lista de todas las palabras
almacenadas o salir. Crea esta tercera versión con un Dictionary<string,string>.
*/
