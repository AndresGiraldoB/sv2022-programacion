...
/*
192. Haz una nueva variante del ejercicio anterior: Crea un diccionario simple
de inglés a español: el programa deberá contener al menos 10 palabras prefijadas.
Mostrará un menú que permita añadir una nueva palabra (junto con su traducción),
buscar la traducción de una palabra, ver la lista de todas las palabras almacenadas
o salir. Crea esta segunda versión con una tabla Hash.
*/
    ...
    static void Main()
    {
        ...
        do
        {
            ...
            switch (MostrarMenu())
            {
                ...
                case "3":
                    IDictionaryEnumerator enumerador = diccio.GetEnumerator();
