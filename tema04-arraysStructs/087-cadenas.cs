...
class Ejercicios
{
    ...
    static void Main()
    {
        ...
        // Si tiene más de 4 letras, elimine la segunda letra y la tercera letra y guardar
        // en una cadena nueva
        string cadenaRemove = cadena;
        if (cadena.Length > 4)
        {
            cadenaRemove = cadena.Remove(1, 2);
        }
        Console.WriteLine(cadenaRemove);

        // Si tiene más de 3 letras, Inserte "yo" después de la segunda letra y guardar
        // en una cadena nueva
        ...
        // Reemplace todos los espacios (' ') por guiones ('-') y guardar en una cadena nueva
