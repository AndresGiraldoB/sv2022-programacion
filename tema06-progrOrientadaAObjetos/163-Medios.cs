...
/*
163. Crea una nueva versión del ejercicio 157 (Medios), a partir de la "solución
oficial", en la que la clase Medio sea abstracta y la clase Sonido sea sellada.
Comprueba que no puedes crear objetos de la clase Medio ni heredar de la clase
Sonido.
*/
...
class PruebaDeMedios
{
    static void Main()
    {
        ...
        // No se puede crear una instancia de la interfaz o del tipo abstracto 'Medio'
        // medios[5] = new Medio("Autor", "Tamaño", "Fomato");
...
// 'SonidoDirecto': no puede derivar del tipo sellado 'Sonido'

// class SonidoDirecto :Sonido
// {
// }
