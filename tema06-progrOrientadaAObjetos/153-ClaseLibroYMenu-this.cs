/*
 153. Crea una nueva versión del ejercicio 148 (clase Libro y menú asociado), a 
 partir de la "solución oficial", en la que emplees "this" en el constructor de 
 "Libro" y añadas un constructor que permita indicar título y año, sin autor 
 (que se guardará como "Desconocido"). Este segundo constructor debe apoyarse 
 en el primero. Al añadir datos desde el menú, deberás usar el constructor 
 original si se indica autor, o el nuevo, en caso de que el autor se deje en 
 blanco (el usuario introduzca una cadena vacía). */
