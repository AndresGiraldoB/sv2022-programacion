﻿/*178. Sistema domótico (examen del tema 6, grupo presencial, 2015-2016)
...
class SistemaDomotico
{
    static void Main()
    {
        ...
        AnyadirDispositivos(dispositivos);
        string opcion;
    ...
    static void AnyadirDispositivos(Dispositivo[] dispositivos)
    {
...
class AparatoEncendible : Dispositivo
{
...
class ElementoCalefactable : Dispositivo
{
