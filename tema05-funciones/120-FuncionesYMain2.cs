/*120.  Crea una versión mejorada del "Main" del ejercicio anterior, 
con los siguientes cambios:

Si no se usan parámetros, o si se especifica un primer parámetro 
incorrecto, se mostrará "Uso: primoc / mm / centrar / mcd" y regresará 
al sistema operativo con el código de error 1. Por otra parte, si se 
usan menos parámetros de los esperados (es decir, : "primoc" y ningún 
número, "mcd" y menos de dos números, y así sucesivamente), mostrará 
"Faltan parámetros" y regresará al sistema operativo con el código de 
error 2. Si todo es correcto, regresará al sistema operativo con código 
de error 0.
