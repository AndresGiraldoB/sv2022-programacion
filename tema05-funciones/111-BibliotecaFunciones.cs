...
/*
 * 111. Crea una nueva versión del ejercicio 89 (Biblioteca), partiendo
 * de la versión oficial que tienes compartida. En esta versión, cada opción 
 * del menú principal se debe extraer a una función. Por lo general, cada una 
 * de estas funciones deberá recibir como parámetros el array con los datos y 
 * el contador de cuántos datos hay almacenados, de modo que no existan variables 
 * locales, sino variables locales y datos pasados como parámetros. También puedes 
 * crearte las funciones auxiliares que consideres útiles (por ejemplo, una para pedir 
 * un texto no vacío, que simplifique la opción de Añadir, y/o una que compruebe si 
